...
namespace Test\Bundle\ContactBundle\Controller;
...
use Test\Bundle\ContactBundle\Entity\Form;
use Test\Bundle\ContactBundle\Form\FormType;
...
class FormController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestContactBundle:Form')->findAll();
     ...
     * @Method("POST")
     * @Template("TestContactBundle:Form:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestContactBundle:Form')->find($id);
     ...
     * @Method("PUT")
     * @Template("TestContactBundle:Form:edit.html.twig")
     */
